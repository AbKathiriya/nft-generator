...
const description = "Awakened NFT";
...
const layers = [
  addLayer("Layer 1 - Skies", { x: 0, y: 0 }, { width: width, height: height }),
  addLayer("Layer 2 - Clouds"),
  addLayer("Layer 3 - Logos"),
  addLayer("Layer 4 - Foregrounds"),
  addLayer("Layer 5 - Birds"),
  addLayer("Layer 6 - Flares"),
  addLayer("Layer 7 - Ranks"),
];
...
addRarityPercentForLayer("original", "Layer 7 - Ranks", {
  super_rare: 0,
  rare: 0,
  original: 100,
});
